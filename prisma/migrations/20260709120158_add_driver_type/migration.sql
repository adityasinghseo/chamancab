...
CREATE TABLE "new_Driver" (
    ...
    "name" TEXT NOT NULL,
    "driverType" TEXT NOT NULL DEFAULT 'manual',
...
INSERT INTO "new_Driver" ("automaticPrice", "costPerHour", "createdAt", "dutyHours", "fullTimePrice", "halfTimePrice", "id", "isActive", "name", "nightCharge", "updatedAt") SELECT "automaticPrice", "costPerHour", "createdAt", "dutyHours", "fullTimePrice", "halfTimePrice", "id", "isActive", "name", "nightCharge", "updatedAt" FROM "Driver";
DROP TABLE "Driver";
